 ...
 * @param <LearningResourceService>
 * */
@WebMvcTest(LearningResourceController.class)
public class LearningResourceControllerTests<LearningResourceService> {
    ...
    @Test
    public <LearningResource> void getAllTheAvailableLearningResources() throws Exception {
    ...
    @Test
    public <LearningResource> void saveTheGivenLearningResources() throws Exception {
